...
const userSchema = new Schema(
  {
    ...
    networkProfileType: { type: String, enum: ["artist", "collector", "gallery", "event_series", "curator", "institution", "art_enthusiast", "other"] },
    networkRoleSelectionCompleted: { type: Boolean, default: false },
    networkOnboardingCompleted: { type: Boolean, default: false },
