...
export async function POST(req: Request) {
  ...
  if ((context.canonicalArtist.profileImages?.avatarUrl || "") !== parsed.data.profile.avatarUrl.trim()) artistChangedFields.push("profileImages.avatarUrl");
  if ((context.canonicalArtist.profileImages?.heroUrl || "") !== parsed.data.profile.heroUrl.trim()) artistChangedFields.push("profileImages.heroUrl");
  ...
  await CanonicalArtistModel.updateOne(
    { _id: context.canonicalArtist._id },
    {
      $set: {
        ...
        profileImages: {
          avatarUrl: parsed.data.profile.avatarUrl.trim() || undefined,
          heroUrl: parsed.data.profile.heroUrl.trim() || undefined,
          galleryUrls,
        },
        consents: {
